         ...
         <a class="navbar-left" href="doncar.do?command=member_main">
            ...
            <ul class="nav nav-tabs ">
               ...
               <li class="nav-item"><a role="presentation" class="nav nav-tabs nav-justified" href="doncar.do?command=carboard_selectlist">카풀예약</a> <c:choose>
                     ...
                     <c:otherwise>
                        <li class="nav-item "><a role="presentation" class="nav nav-tabs nav-justified" href="doncar.do?command=member_selectone&member_no=${MemberDto.member_no}">마이페이지</a></li>
                     </c:otherwise>
                  </c:choose>
               <li><a role="presentation" class="nav nav-tabs nav-justified" href="">1:1채팅문의</a></li>
